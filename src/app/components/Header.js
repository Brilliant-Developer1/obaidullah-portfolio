...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center py-4 px-8 bg-white shadow sticky top-0 w-full z-10">
      <h1 className="text-xl xl:text-2xl font-semibold text-primary">WEB DEVELOPER</h1>
      ...
      {menuOpen && (
        <nav className="md:hidden absolute top-14 left-0 w-full bg-white shadow-lg ">
          <div className="flex flex-col items-center space-y-4 py-4 px-8">
            ...
            <ScrollLink to="skills" smooth={true} className="relative group cursor-pointer" onClick={() => setMenuOpen(false)}>
              <span className="hover:text-primary">Skills</span>
              <span className="absolute left-0 bottom-0 w-full h-0.5 bg-primary transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
            </ScrollLink>
            <ScrollLink to="education" smooth={true} className="relative group cursor-pointer" onClick={() => setMenuOpen(false)}>
              <span className="hover:text-primary">Education</span>
              <span className="absolute left-0 bottom-0 w-full h-0.5 bg-primary transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
            </ScrollLink>
            ...
            <Link href="https://drive.google.com/file/d/1rJvhqtdq0iBdYjYeAvUF0PxrW9gLjNmi/view?usp=sharing" target="_blank" className="relative group cursor-pointer" onClick={() => setMenuOpen(false)}>
              <span className="hover:text-primary">Resume</span>
              <span className="absolute left-0 bottom-0 w-full h-0.5 bg-primary transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
            </Link>
